...
public class LocalStack extends Stack {
    ...
    public LocalStack (final App scope, final String id, final StackProps props) {
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "bXlzZWNyZXRrZXl0aGF0aXNsb25nZW5vdWdoZm9yand0dG9rZW5zMTIzNDU2Nzg5MA=="));
    ...
    private Vpc createVpc() {
        return Vpc.Builder.create(this, "ManagementSystemVPC")
                .vpcName("ManagementSystemVPC")
                .maxAzs(2)
                .build();
    }
    ...
    private Cluster createEcsCluster() {
        return Cluster.Builder.create(this, "ManagementSystemCluster")
                .vpc(vpc)
                .defaultCloudMapNamespace(CloudMapNamespaceOptions.builder()
                        .name("management-system.local")
                        .build())
                .build();
    }
